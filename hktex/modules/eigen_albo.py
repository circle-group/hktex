...
@hktex.register("modules.eigen-albo-interpolation")
class EigenAlboInterpolation(BaseObject):
    ...
    def precompute_all_eigen(self) -> Tuple[torch.Tensor, torch.Tensor, torch.Tensor]:
        ...
        if fpath is None or not self.cfg.use_precomputed:
            ...
            hktex.info(f"Loading precomputed albo eigen from {precomputed_path}")
            try:
                ...
                hktex.info(f"Precomputed albo eigen not found")
    ...
    def _precompute_all_aniso_eigen(
        ...
        hktex.info("Computing all eigendecompositions")
