...
import hktex
from hktex.utils import BaseObject, interpolate_barycentric_attr_from_trivertidx
from hktex.utils.typing import *

from .mesh import Mesh
from .eigen_albo import EigenAlboInterpolation

import hktex.knn_heat as knn_heat

__all__ = ["EigenAlboInterpolationKNN"]


@hktex.register("modules.eigen-albo-interpolation-knn")
