...
if __name__ == "__main__":
    ...
    p.add_argument(
        "--benchmark_csv",
        type=str,
        default="outputs/mlp_benchmark/benchmark_results_mlp_hash.csv",
    )
    p.add_argument(
        "--encoding",
        type=str,
    ...
    tuner = tune.Tuner(
        ...
        run_config=tune.RunConfig(
            storage_path=os.path.abspath(args.output_dir), name="time_mlp_render"
        ),
    )
    ...
    output_csv = os.path.join(args.output_dir, "time_mlp_render_results.csv")
